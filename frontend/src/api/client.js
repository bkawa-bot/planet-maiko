...
export const api = {
  ...
  stopWorkflowRun: (runId) =>
    request(`/workflow-runs/${runId}/stop`, { method: "POST" }),
  ...
  requestChangesWorkflowNode: (runId, nodeRunId, feedback) =>
    request(`/workflow-runs/${runId}/nodes/${nodeRunId}/request-changes`, {
