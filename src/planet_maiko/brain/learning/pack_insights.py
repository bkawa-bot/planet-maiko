...
def start_gathering():
    ...
    prompt = (
        "End-of-day check-in around the campfire. Reflect on your work "
        "today and share three kinds of things via separate reply "
        "calls:\n\n"
        ...
        "   These feed the LoRA compliance model. One fact per reply. "
        "Skip if nothing rule-like came up.\n\n"
        ...
        "One fact per reply.\n\n"
        "3. SUMMARY — one cheerful sentence describing your day, the "
        "kind of thing you'd say to the rest of the pack around the "
        "campfire. Keep it short and voice-y — \"Today I learned all "
        "about elastic search indexing\", \"Spent the afternoon "
        "untangling our auth middleware\". Send exactly one summary at "
        "the end. Use:\n"
        "   reply(content=\"<one sentence>\", message_type=\"summary\")\n\n"
        "If you don't have anything to say, a short "
        "reply(content=\"nothing new\", message_type=\"status\") is fine "
        "— you can skip all three. You can continue working on the task "
        "afterward."
    )
