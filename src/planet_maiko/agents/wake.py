        ...
        try:
            ...
            if transcript_missing:
                ...
                seeded_prompt = (
                    ...
                    "a different machine, or a restored database). Only the "
                    "chat history is gone. You are still in your existing "
                    "git worktree, on the SAME branch, with all of your "
                    "prior commits and any uncommitted changes intact. "
                    "Before doing anything, orient yourself: run "
                    "`git status` and `git log --oneline -20` to see "
                    "exactly what you already did, and re-read TASK.md and "
                    "CLAUDE.md in your working directory. Keep committing "
                    "to this same branch. Recap:\n\n"
                    f"{recap}\n\n"
